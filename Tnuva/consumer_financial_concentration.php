...
$page_nav["data_sheets"]["sub"]["tnuva"]["sub"]["consumer_financial_concentration"]["active"] = true;
include(DIRECTORY."/inc/nav.php");

// Get table data

$table = $my_db->Get_Tnuva_Consumer_Financial_Concentration($_SESSION['diary_milk_username'],$chosen_year);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
			...
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-5">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-table fa-fw "></i>
						<?=$lang['DATA_SHEETS']?>
					<span>>
						<?=$lang['TNUVA']?> > <?=$lang['CONSUMER_FINANCIAL_CONCENTRATION']?>
					</span>
				</h1>
			</div>
		</div>

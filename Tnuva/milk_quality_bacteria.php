...
$page_nav["data_sheets"]["sub"]["tnuva"]["sub"]["milk_quality_bacteria"]["active"] = true;
include(DIRECTORY."/inc/nav.php");

// Get table data
//$table = $my_db->Get_Strauss_Milk_Quality_Bacteria('4049331',$StartDate,$FinishDate);
$table = $my_db->Get_Tnuva_Milk_Quality_Bacteria($_SESSION['diary_milk_username'],$StartDate,$FinishDate);
$table2 = $my_db->Get_Tnuva_Milk_Quality_Somatic($_SESSION['diary_milk_username'],$StartDate,$FinishDate);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
			...
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-5">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-table fa-fw "></i>
						<?=$lang['DATA_SHEETS']?>
					<span>>
						<?=$lang['TNUVA']?> > <?=$lang['MILK_QUALITY_BACTERIA']?>
					</span>
				</h1>
			</div>
		</div>

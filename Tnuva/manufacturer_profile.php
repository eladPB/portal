...
$page_nav["data_sheets"]["sub"]["tnuva"]["sub"]["manufacturer_profile"]["active"] = true;
include(DIRECTORY."/inc/nav.php");

// Get table data
$table = $my_db->Get_Tnuva_Manufacturer_Profile($_SESSION['diary_milk_username'],$StartDate,$FinishDate);
			...
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-5">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-table fa-fw "></i>
						<?=$lang['DATA_SHEETS']?>
					<span>>
						<?=$lang['TNUVA']?> > <?=$lang['MANUFACTURER_PROFILE']?>
					</span>
				</h1>
			</div>
		</div>

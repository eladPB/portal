...
$page_nav["data_sheets"]["sub"]["tnuva"]["sub"]["marketing_vs_cover"]["active"] = true;
include(DIRECTORY."/inc/nav.php");

// Get table data
$table = $my_db->Get_Tnuva_Marketing_Vs_Cover($_SESSION['diary_milk_username'],$chosen_year);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-5">
				<h1 class="page-title txt-color-blueDark">
                    ...
                    <?=$lang['DATA_SHEETS']?>
					<span>>
						<?=$lang['TNUVA']?> > <?=$lang['MARKETING_VS_COVER']?>
					</span>
				</h1>
			</div>
		</div>

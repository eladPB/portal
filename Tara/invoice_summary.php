...
$page_title = $lang['INVOICE_SUMMARY'];
...
$page_nav["data_sheets"]["sub"]["tara"]["sub"]["invoice_summary"]["active"] = true;
...
$table = $my_db->Get_Tara_Invoice_Summary($_SESSION['diary_milk_username'],$StartDate,$FinishDate);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
			...
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-5">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-table fa-fw "></i>
						<?=$lang['DATA_SHEETS']?>
					<span>>
						<?=$lang['TARA']?> > <?=$lang['INVOICE_SUMMARY']?>
					</span>
				</h1>
			</div>
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false" >
						...
						<header>
							...
							<h2><?=$lang['INVOICES_CONCENTRATION']?></h2>

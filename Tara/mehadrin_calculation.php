...
$page_title = $lang['MEHADRIN_CALCULATION'];
...
$page_nav["data_sheets"]["sub"]["tara"]["sub"]["mehadrin_calculation"]["active"] = true;
require_once("../inc/nav.php");

// Get table data
$table = $my_db->Get_Tara_Mehadrin_Calculation('4046515',$chosen_year);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
			...
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-5">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-table fa-fw "></i>
						<?=$lang['DATA_SHEETS']?>
					<span>>
						<?=$lang['TARA']?> > <?=$lang['MEHADRIN_CALCULATION']?>
					</span>
				</h1>
			</div>
		</div>
		...
		<section id="widget-grid" class="">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <? for ($i=0; $i<=5; $i++):?>
                        <li><a href="mehadrin_calculation.php?Year=<?= date("Y")-$i?>"><?echo date("Y")-$i?></a></li>
                    <? endfor;?>
                </ul>
            </div>
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false" >
						...
						<header>
							...
							<h2><?=$lang['MEHADRIN_CALCULATION']?></h2>
								...
								<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
                                            ...
                                            <?=$lang['COL_AnnualCap']?>
                                            <?=$lang['COL_MonthlyCover']?>
                                            <?=$lang['COL_MehadrinDairyTariff']?>
                                            <?=$lang['COL_MonthlyAmount']?>
                                            <?=$lang['COL_PercentApproval']?>
                                            <?=$lang['COL_Differences']?>
                                            <?=$lang['COL_TotalMonthlyCredit']?>
										</tr>
									</thead>
									<tbody>
                                    <?echo $table ?>

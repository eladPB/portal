...
$page_title = $lang['ANNUAL_SUMMARY'];
...
$page_nav["data_sheets"]["sub"]["tara"]["sub"]["annual_summary"]["active"] = true;
include(DIRECTORY."/inc/nav.php");


// Get table data
$table = $my_db->Get_Tara_Annual_Summary($_SESSION['diary_milk_username'],$chosen_year);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
		...
		<section id="widget-grid" class="">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <? for ($i=0; $i<=5; $i++):?>
                        <li><a href="annual_summary.php?Year=<?= date("Y")-$i?>"><?echo date("Y")-$i?></a></li>
                    <? endfor;?>
                </ul>
            </div>

...
$page_title = "Milk Quality Report";
...
$page_nav["data_sheets"]["sub"]["tara"]["sub"]["milk_quality_report"]["active"] = true;
...
// Get table data
$table = $my_db->Get_Tara_Milk_Quality_Report($_SESSION['diary_milk_username'],$StartDate,$FinishDate);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
			...
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-5">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-table fa-fw "></i>
						<?=$lang['DATA_SHEETS']?>
					<span>>
						<?=$lang['TARA']?> > <?=$lang['MILK_QUALITY_REPORT']?>
					</span>
				</h1>
			</div>
		</div>
								...
								<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
                                            ...
                                            <?=$lang['COL_SOMATIC']?>
                                            <?=$lang['COL_SOMATIC_CLASSIFICATION']?>
                                            <?=$lang['COL_BACTERIA']?>
                                            <?=$lang['COL_BACTERIA_CLASSIFICATION']?>
										</tr>
									</thead>
									<tbody>
                                    <?echo $table ?>

...
$page_nav ["monitoring"] ["sub"] ["smaxtec"] ["sub"] ["sensor_humidity"] ["active"] = true;
...
$Avg_Humidity = $my_db->Get_Smaxtec_Sensor_Avg_Humidity($_SESSION['farm_id'],$PeriodBack);
$sensor_arr = $my_db->Get_Smaxtec_Sensor_Humidity ($_SESSION['farm_id'],$PeriodBack);
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-5">
                <h1 class="page-title txt-color-blueDark">
                    ...
                    <?=$lang['MONITORING']?>
							<span>>
                                <?=$lang['SMAXTEC']?> > <?=$lang['SENSOR_HUMIDITY']?>
							</span>
                </h1>
            </div>
            <!-- end col -->
        ...
        <section id="widget-grid" class="">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li><a href="./sensor_humidity.php?PeriodBack=3&Tag=<?=$lang['LAST_3_HOURS']?>"><?=$lang['LAST_3_HOURS']?></a></li>
                    <li><a href="./sensor_humidity.php?PeriodBack=24&Tag=<?=$lang['LAST_24_HOURS']?>"><?=$lang['LAST_24_HOURS']?></a></li>
                    <li><a href="./sensor_humidity.php?PeriodBack=48&Tag=<?=$lang['LAST_48_HOURS']?>"><?=$lang['LAST_48_HOURS']?></a></li>
                    <li><a href="./sensor_humidity.php?PeriodBack=168&Tag=<?=$lang['LAST_WEEK']?>"><?=$lang['LAST_WEEK']?></a></li>
                    <li><a href="./sensor_humidity.php?PeriodBack=504&Tag=<?=$lang['MAX']?>"><?=$lang['MAX']?></a></li>
                </ul>
            </div>
            <!-- row -->
            <div class="row">
                ...
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false">
                        ...
                        <header>
                            ...
                            <h2><?=$lang['AVERAGE_SENSOR_HUMIDITY']?></h2>
...
<script type="text/javascript">
    ...
    var sensor_header = 'Date,Humidity\n';
    var sensor_data = "<?echo $Avg_Humidity; ?>";
    ...
    $(document).ready(function() {
        ...
        g<?=$i?> = new Dygraph(document.getElementById("noroll_<?= $sensor_name?>"), sensor<?= $sensor_name?>_data, {
            customBars : false,
            title : 'Sensor <?= $sensor_name?> - Humidity',
            ylabel : '',
            legend : 'always',
            labelsDivWidth : 280 ,
            labelsDivStyles : {

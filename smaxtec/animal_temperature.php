...
$page_title = $lang['ANIMAL_TEMPERATURE'];
...
$page_nav ["monitoring"] ["sub"] ["smaxtec"] ["sub"] ["animal_temperature"] ["active"] = true;
...
$result = $my_db->Get_Smaxtec_Animal_Avg_Temperature($_SESSION['farm_id'],$PeriodBack);
//$animals_arr = $my_db->Get_Smaxtec_Animal_Temperature_Reduction($_SESSION['farm_id'],$PeriodBack);
$animals_arr = $my_db->Get_Smaxtec_Animal_Temperature($_SESSION['farm_id'],$PeriodBack);
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-5">
						<h1 class="page-title txt-color-blueDark">
                            ...
                            <?=$lang['MONITORING']?>
							<span>>
                                <?=$lang['SMAXTEC']?> > <?=$lang['ANIMAL_TEMPERATURE']?>
							</span>
						</h1>
					</div>
					<!-- end col -->
				...
				<section id="widget-grid" class="">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="./animal_temperature.php?PeriodBack=3&Tag=<?=$lang['LAST_3_HOURS']?>"><?=$lang['LAST_3_HOURS']?></a></li>
                            <li><a href="./animal_temperature.php?PeriodBack=25&Tag=<?=$lang['LAST_24_HOURS']?>"><?=$lang['LAST_24_HOURS']?></a></li>
                            <li><a href="./animal_temperature.php?PeriodBack=49&Tag=<?=$lang['LAST_48_HOURS']?>"><?=$lang['LAST_48_HOURS']?></a></li>
                            <li><a href="./animal_temperature.php?PeriodBack=169&Tag=<?=$lang['LAST_WEEK']?>"><?=$lang['LAST_WEEK']?></a></li>
                            <li><a href="./animal_temperature.php?PeriodBack=52560&Tag=<?=$lang['MAX']?>"><?=$lang['MAX']?></a></li>
                        </ul>
                    </div>
					<!-- row -->
					<div class="row">
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false">
								...
								<header>
									...
									<h2><?=$lang['AVERAGE_ANIMAL_TEMPERATURE']?></h2>

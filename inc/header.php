...
if (isset($_SESSION['my_farm']['name'])):
    $farm_name = $_SESSION['my_farm']['name'];
else:
    $farm_name = "No Farms";
...
?><!DOCTYPE html>
<html lang="en-us" <?= (($_SERVER['REQUEST_URI']=='/login.php')?'class="login_bg" ':'')?><?php echo implode(' ', array_map(function($prop, $value) {
			return $prop.'="'.$value.'"';
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>SmartFarm </title>
	...
	<body <?php echo (($lang['PAGE_DIRECTION']=='rtl')?'class="smart-rtl fixed-page-footer" ':'class="fixed-page-footer" '); echo implode(' ', array_map(function($prop, $value) {
			return $prop.'="'.$value.'"';
		...
		?>
				...
				<header id="header">
					<div id="logo-group">
						...
						<span id="activity" class="activity-dropdown"> <i class="fa fa-user"></i> <b class="badge hidden"> ! </b> </span>
						...
						<div class="ajax-dropdown">
							...
							<div class="btn-group btn-group-justified" data-toggle="buttons">
								<label class="btn btn-default">
									<input type="radio" name="activity" id="<?php echo APP_URL; ?>/inc/ajax_events.php">
									Msgs</label><? /*
								<label class="btn btn-default">
							...
							<!-- footer: refresh area -->
							<span>Last updated on: <span id="ajax_events_last_update"><?= date('d/m/Y H:i')?></span>
								<button type="button" data-url="<?php echo APP_URL; ?>/inc/ajax_events.php" data-loading-text="<i class='fa fa-refresh fa-spin'></i> Loading..." class="btn btn-xs btn-default pull-right">
					...
					<div class="project-context">
						...
						<span class="label"><?=$lang['FARMS']?>:</span>
						<span id="project-selector" class="popover-trigger-element dropdown-toggle" data-toggle="dropdown"><?=$farm_name?> <i class="fa fa-angle-down"></i></span>
						...
						<ul class="dropdown-menu">
							...
							<li>
                                <a href="<? echo ASSETS_URL . '/index.php?change_farm_id='. $farm['id']?>" > <?=$farm['name']?></a>
							...
							if (empty($farms)):?>
								<li>
									<a href="javascript:void(0);"><?=$lang['YOU_HAVE_NO_FARMS']?></a>
								</li>
							<?endif;?>
						</ul>
						<!-- end dropdown-menu-->
						...
						<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
							<li class="">
								...
								<ul class="dropdown-menu pull-right">
									...
									<li class="divider"></li>
									<li>
										<a href="setting/logout.php" class="padding-10 padding-top-5 padding-bottom-5" data-action="userLogout"><i class="fa fa-sign-out fa-lg"></i> <strong><u>L</u>ogout</strong></a>
									</li>
								</ul>
							</li>
						</ul>
						...
						<ul class="header-dropdown-list hidden-xs">
							<li>
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">
									...
									<img src="<?php echo ASSETS_URL; ?>/img/blank.gif" class="flag flag-us" alt="United States"> <span> English (US) </span> <i class="fa fa-angle-down"></i>
									<? elseif ($_SESSION['language'] == 'he'): ?>
										<img src="<?php echo ASSETS_URL; ?>/img/blank.gif" class="flag flag-il" alt="ישראל"> <span> עברית (he) </span> <i class="fa fa-angle-down"></i>
									<? elseif ($_SESSION['language'] == 'cn'): ?>
										<img src="<?php echo ASSETS_URL; ?>/img/blank.gif" class="flag flag-cn" alt="Chinease"> <span> 中文 (cn) </span> <i class="fa fa-angle-down"></i>
									<? endif;?>
								</a>
								<ul class="dropdown-menu pull-right">
									<li<?= (($_SESSION['language'] == 'en')?' class="active"':'')?>>
										<a href="javascript:changeLang('en');"><img src="<?php echo ASSETS_URL; ?>/img/blank.gif" class="flag flag-us" alt="United States"> English (US)</a>
									</li>
									<li<?= (($_SESSION['language'] == 'cn')?' class="active"':'')?>>
										<a href="javascript:changeLang('cn');"><img src="<?php echo ASSETS_URL; ?>/img/blank.gif" class="flag flag-cn" alt="China"> 中文</a>
									</li>	
									<li<?= (($_SESSION['language'] == 'he')?' class="active"':'')?>>
										<a href="javascript:changeLang('he');"><img src="<?php echo ASSETS_URL; ?>/img/blank.gif" class="flag flag-il" alt="Hebrew"> עברית</a>
									</li>
								</ul>
							</li>
						</ul>
...
<!--						</li>-->
<!--                        <li>-->
<!--                            <a href="http://54.210.52.142/QvAJAXZfc/opendoc.htm?document=DairyFarm_Analysis%2FControl%20Room.qvw&host=QVS%40win-qha7m6aogva" url_target="_blank" class="jarvismetro-tile big-cubes bg-color-blue"> <span class="iconbox"> <i class="fa fa-windows fa-4x"></i> <span>Analytics </span> </span> </a>-->
<!--                        </li>-->
						<li>
							<a href="<?php echo APP_URL; ?>/profile.php" class="jarvismetro-tile big-cubes bg-color-pinkDark" > <span class="iconbox"> <i class="fa fa-user fa-4x"></i> <span><?=$lang['MY_PROFILE']?> </span> </span> </a>
						</li>
					</ul>
				</div>
				<!-- END SHORTCUT AREA -->

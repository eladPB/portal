...
$page_title = $lang['CONSUMER_FINANCIAL_CONCENTRATION'];
...
$page_nav["data_sheets"]["sub"]["strauss"]["sub"]["consumer_financial_concentration"]["active"] = true;
include(DIRECTORY."/inc/nav.php");

// Get table data

$table = $my_db->Get_Strauss_Consumer_Financial_Concentration($_SESSION['diary_milk_username'],$chosen_year);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
			...
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-5">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-table fa-fw "></i>
						<?=$lang['DATA_SHEETS']?>
					<span>>
						<?=$lang['STRAUSS']?> > <?=$lang['CONSUMER_FINANCIAL_CONCENTRATION']?>
					</span>
				</h1>
			</div>
		</div>
		...
		<section id="widget-grid" class="">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <? for ($i=0; $i<=5; $i++):?>
                        <li><a href="consumer_financial_concentration.php?Year=<?= date("Y")-$i?>"><?echo date("Y")-$i?></a></li>
                    <? endfor;?>
                </ul>
            </div>
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false" >
						...
						<header>
							...
							<h2><?=$lang['CONSUMER_FINANCIAL_CONCENTRATION']?></h2>
								...
								<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
                                            <?=$lang['COL_INDEX']?>
                                            <?=$lang['COL_MONTH']?>
                                            <?=$lang['COL_TARGETPRICE']?>
                                            <?=$lang['COL_MILKAMOUNT']?>
                                            <?=$lang['COL_MILKSUM']?>
                                            <?=$lang['COL_FATSUM']?>
                                            <?=$lang['COL_PROTEINSUM']?>
                                            <?=$lang['COL_BACTERIASUM']?>
                                            <?=$lang['COL_SOMATICSUM']?>
                                            <?=$lang['COL_CANCELLATIONCOUNCIL']?>
                                            <?=$lang['COL_ADDITIONALCHARGES']?>
                                            <?=$lang['COL_TOTALCORRECTIONS']?>
                                            <?=$lang['COL_TOTALKOSHER']?>
                                            <?=$lang['COL_LITERCOST']?>
                                            <?=$lang['COL_TOTALPAY']?>
										</tr>
									</thead>

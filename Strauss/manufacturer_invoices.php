...
$page_title = $lang['MANUFACTURER_INVOICES'];
...
$page_nav["data_sheets"]["sub"]["strauss"]["sub"]["manufacturer_invoices"]["active"] = true;
include(DIRECTORY."/inc/nav.php");


// Get table data
$table = $my_db->Get_Strauss_Manufacturer_Invoices($_SESSION['diary_milk_username'],$StartDate,$FinishDate);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
			...
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-5">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-table fa-fw "></i>
						<?=$lang['DATA_SHEETS']?>
					<span>>
						<?=$lang['STRAUSS']?> > <?=$lang['MANUFACTURER_INVOICES']?>
					</span>
				</h1>
			</div>
		</div>
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false" >
						...
						<header>
							...
							<h2><?=$lang['INVOICES_MANUFACTURER']?></h2>
							...
							<div class="widget-body no-padding">
								...
								<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
											<?=$lang['COL_INDEX']?>
                                            <?=$lang['COL_PRODUCTIONDATE']?>
                                            <?=$lang['COL_PAYDATE']?>
                                            <?=$lang['COL_VATDATE']?>
                                            <?=$lang['COL_ACCOUNTTYPE']?>
                                            <?=$lang['COL_INVOICENUM']?>
                                            <?=$lang['COL_FROMDATE']?>
                                            <?=$lang['COL_TODATE']?>
                                            <?=$lang['COL_TOTALPREVAT']?>
                                            <?=$lang['COL_VAT']?>
										</tr>
									</thead>
									<tbody>

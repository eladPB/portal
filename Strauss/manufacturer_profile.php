...
$page_title = $lang['MANUFACTURER_PROFILE'];
...
$page_nav["data_sheets"]["sub"]["strauss"]["sub"]["manufacturer_profile"]["active"] = true;
include(DIRECTORY."/inc/nav.php");

// Get table data
$table = $my_db->Get_Strauss_Manufacturer_Profile($_SESSION['diary_milk_username'],$StartDate,$FinishDate);
			...
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-5">
				<h1 class="page-title txt-color-blueDark">
					<i class="fa fa-table fa-fw "></i>
						<?=$lang['DATA_SHEETS']?>
					<span>>
						<?=$lang['STRAUSS']?> > <?=$lang['MANUFACTURER_PROFILE']?>
					</span>
				</h1>
			</div>
		</div>
								...
								<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
                                            ...
                                            <?=$lang['COL_DAIRY']?>
                                            <?=$lang['COL_TANKER']?>
                                            <?=$lang['COL_DELIVERYNUMBER']?>
                                            <?=$lang['COL_REPORTEDMILK']?>
                                            <?=$lang['COL_APPROVEMILK']?>
                                            <?=$lang['COL_INVALIDMILK']?>
                                            <?=$lang['COL_FATPERCENTAGE']?>
                                            <?=$lang['COL_PROTEINPERCENTAGE']?>
                                            <?=$lang['COL_LACTOSEPERCENTAGE']?>
                                            <?=$lang['COL_ACIDITY']?>
                                            <?=$lang['COL_TEMPERATURE']?>
                                            <?=$lang['COL_WATERPERCENT']?>
                                            <?=$lang['COL_MA']?>
                                            <?=$lang['COL_TA']?>
                                            <?=$lang['COL_MR']?>
                                            <?=$lang['COL_RH']?>

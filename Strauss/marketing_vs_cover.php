...
$page_title = $lang['MARKETING_VS_COVER'];
...
$page_nav["data_sheets"]["sub"]["strauss"]["sub"]["marketing_vs_cover"]["active"] = true;
include(DIRECTORY."/inc/nav.php");

// Get table data
$table = $my_db->Get_Strauss_Marketing_Vs_Cover($_SESSION['diary_milk_username'],$chosen_year);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-5">
				<h1 class="page-title txt-color-blueDark">
                    ...
                    <?=$lang['DATA_SHEETS']?>
					<span>>
						<?=$lang['STRAUSS']?> > <?=$lang['MARKETING_VS_COVER']?>
					</span>
				</h1>
			</div>
		</div>
		...
		<section id="widget-grid" class="">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <? for ($i=0; $i<=5; $i++):?>
                        <li><a href="marketing_vs_cover.php?Year=<?= date("Y")-$i?>"><?echo date("Y")-$i?></a></li>
                    <? endfor;?>
                </ul>
            </div>
								...
								<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
                                            ...
                                            <?=$lang['COL_CUMULATIVECOVER']?>
                                            <?=$lang['COL_INNOVATIVEMARKETING']?>
                                            <?=$lang['COL_CUMULATIVE']?>
                                            <?=$lang['COL_SUPPLY']?>
                                            <?=$lang['COL_A_QUANTITY']?>
                                            <?=$lang['COL_A_SUM']?>

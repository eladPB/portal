...
$page_nav["setting"]["sub"]["farm_list"]["active"] = true;
include(DIRECTORY."/inc/nav.php");

// Get table data
$table = $my_db->GetFarms();
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <table id="datatable_tabletools2" class="table table-striped table-bordered table-hover" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th data-hide="phone,tablet"><?=$lang['ALIAS']?></th>
                                            <th data-hide="phone,tablet"><?=$lang['ADDRESS']?></th>
                                            <th data-class="expand"><?=$lang['QLIKVIEW_CODE']?></th>
                                            <th data-hide="phone,tablet"><?=$lang['START_DATE']?></th>
                                            <th data-hide="phone,tablet"><?=$lang['COUNTRY']?></th>
                                            <th data-hide="phone,tablet"><?=$lang['EDIT']?></th>
                                            <th data-hide="phone,tablet"><?=$lang['DELETE']?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?echo $table ?>
            ...
            $('#datatable_tabletools2').dataTable({
                ...
                "drawCallback" : function(oSettings) {
					...
					$('.smart-mod-eg1').click(function(e) {
						$this = $(this);
						$this_farmid = $this.data('farmid');
						$.SmartMessageBox({
							title : "Delete Farm ?",
							content : "Are you sure you want to delete farm ?",
							sound : false,
							buttons : '[No][Yes]'
						}, function(ButtonPressed) {
							if (ButtonPressed === "Yes") {
								// ADD AJAX Call to delete the farm
								$.ajax({
									url: "/Setting/ajax_farm.php",
									data: {
										'action':'delete_farm',
										'farmid': $this_farmid,
									...
									.done(function() {
										$.smallBox({
											title : "Farm Deleted",
											content : "<i class='fa fa-clock-o'></i> <i>Farm deleted...</i>",
											sound : false,
											color : "#659265",
									...
									.fail(function() {
										$.smallBox({
											title : "Farm Deleted",
											content : "<i class='fa fa-clock-o'></i> <i>Farm was not deleted.</i>",
											sound : false,
											color : "#c26565",
							...
							if (ButtonPressed === "No") {
								$.smallBox({
									title : "Cancel Delete",
									content : "<i class='fa fa-clock-o'></i> <i>Delete Cancel...</i>",
									sound : false,
									color : "#C46A69",

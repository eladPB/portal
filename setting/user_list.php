...
$page_nav["setting"]["sub"]["users_list"]["active"] = true;
include(DIRECTORY."/inc/nav.php");

// Get table data
$table = $my_db->GetUsers();
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <table id="datatable_tabletools2" class="table table-striped table-bordered table-hover" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th data-class="expand"><?=$lang['FIRST_NAME']?></th>
                                            <th data-hide="phone,tablet"><?=$lang['LAST_NAME']?></th>
                                            <th data-hide="phone,tablet"><?=$lang['PRIVILEGES']?></th>
                                            <th data-hide="phone,tablet"><?=$lang['BIUSER']?></th>
                                            <th data-hide="phone,tablet"><?=$lang['BIPASSWORD']?></th>
                                            <th data-hide="phone,tablet"><?=$lang['FARMS']?></th>
					...
					$('.smart-mod-eg1').click(function(e) {
						...
						$.SmartMessageBox({
							...
							if (ButtonPressed === "Yes") {
								// ADD AJAX Call to delete the user
								$.ajax({
									url: "/Setting/ajax_user.php",
									data: {
										'action':'delete_user',
										'userid': $this_userid,
									...
									.done(function() {
										$.smallBox({
											title : "User Deleted",
											content : "<i class='fa fa-clock-o'></i> <i>User deleted...</i>",
											sound : false,
											color : "#659265",
									...
									.fail(function() {
										$.smallBox({
											title : "User Deleted",
											content : "<i class='fa fa-clock-o'></i> <i>User was not deleted.</i>",
											sound : false,
											color : "#c26565",

...
$page_nav["data_entry"]["sub"]["milk"]["active"] = true;
...
// Get table data
$table = $my_db->Get_Milk($farmid,$StartDate,$FinishDate);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
							...
							<div class="widget-body no-padding">
								...
								<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
                                            <?=$lang['COL_DATE']?>
                                            <?=$lang['COL_PLANING_MILK_QUOTA']?>
                                            <?=$lang['COL_AMOUNT_MARKETED_MILK']?>
                                            <?=$lang['COL_PROTEIN_PERCENTAGE']?>
                                            <?=$lang['COL_FAT_PERCENTAGE']?>
                                            <?=$lang['COL_MILK_INCOME']?>
                                            <?=$lang['COL_MILK_FEE']?>
                                            <?=$lang['COL_TARGET_PRICE']?>
                                            <?=$lang['COL_TARGET_PRICE_LITER']?>
                                            <?=$lang['COL_PERCENT_QUOTA']?>
                                            <?=$lang['COL_MILK_QUOTA']?>
										</tr>
									</thead>
									<tbody>
...
// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $('#datatable_tabletools tbody td').editable('./Update_Milk.php', {
        type      : 'textarea',
        name      : $(this).data('tdid'),
		fatherid  : 'indexid',
        "onblur"  : 'submit',

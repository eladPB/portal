...
$page_title = $lang['SOLER_MEASUREMENT'];
...
$page_nav["data_entry"]["sub"]["soler_measurement"]["active"] = true;
...
// Get table data
$table = $my_db->Get_Soler_Measurement($farmid,$StartDate,$FinishDate);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
...
// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $('#datatable_tabletools tbody td').editable('./update_soler_measurement.php', {
        type      : 'textarea',
        name      : $(this).data('tdid'),
		fatherid  : 'indexid',
        "onblur"  : 'submit',

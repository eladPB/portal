...
// Get table data
$table = $my_db->GetGroupTable($_SESSION['farm_id']);
                            ...
                            <div class="widget-body no-padding">
                                ...
                                <table id="datatable_tabletools2" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th data-class="expand"><?=$lang['GROUP_TO_COW']?></th>
                                        <th data-class="expand"><?=$lang['TIME_TABLE']?></th>
        ...
        $('#datatable_tabletools2').dataTable({
            ...
            "drawCallback" : function(oSettings) {
                ...
                $('.smart-mod-eg1').click(function(e) {
                    ...
                    $.SmartMessageBox({
                        title : "<?=$lang['DEL_GROUP_TITLE']?>",
                        content : "<?=$lang['DEL_GROUP_CONTENT']?>",
                        sound : false,
                        buttons : '<?=$lang['DEL_GROUP_BUTTONS']?>'
                    }, function(ButtonPressed) {
                        if (ButtonPressed === "<?=$lang['DEL_GROUP_YES']?>") {
                            // ADD AJAX Call to delete the group
                            $.ajax({
                                url: "/data_entry/smaxtec_group/ajax_group.php",
                                data: {
                                    'action':'delete_group',
                                ...
                                .done(function() {
                                    $.smallBox({
                                        title : "<?=$lang['DEL_GROUP_DELETE']?>",
                                        content : "<i class='fa fa-clock-o'></i> <i><?=$lang['DEL_GROUP_DELETE_MSG']?></i>",
                                        sound : false,
                                        color : "#659265",
                                ...
                                .fail(function() {
                                    $.smallBox({
                                        title : "<?=$lang['DEL_GROUP_DELETE']?>",
                                        content : "<i class='fa fa-clock-o'></i><?=$lang['DEL_GROUP_NOT_DELETED']?><i></i>",
                                        sound : false,
                                        color : "#c26565",
                        ...
                        if (ButtonPressed === "<?=$lang['DEL_GROUP_NO']?>") {
                            $.smallBox({
                                title : "<?=$lang['DEL_GROUP_CANCEL']?>",
                                content : "<i class='fa fa-clock-o'></i> <i><?=$lang['DEL_GROUP_CANCELED']?></i>",
                                sound : false,
                                color : "#C46A69",

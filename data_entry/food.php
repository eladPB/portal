...
$page_nav["data_entry"]["sub"]["food"]["active"] = true;
...
// Get table data
$table = $my_db->Get_Food($farmid,$StartDate,$FinishDate);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
								...
								<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
                                            <?=$lang['COL_DATE']?>
											<?=$lang['COL_DOSE_CODE']?>
											<?=$lang['COL_NUM_SERVINGS_TRANSFER']?>
											<?=$lang['COL_TRANSFER_FROM_GROUP']?>
											<?=$lang['COL_TRANSFER_TO_GROUP']?>
                                            <?=$lang['COL_FOOD_MILK_KG']?>
                                            <?=$lang['COL_FOOD_CALF_KG']?>
                                            <?=$lang['COL_FOOD_DRY_KG']?>
                                            <?=$lang['COL_FOOD_TOTAL_KG']?>
                                            <?=$lang['COL_WEIGHT_DAIRY_FOOD_KG']?>
                                            <?=$lang['COL_WEIGHT_DAIRY_FEMALE_FOOD_KG']?>
                                            <?=$lang['COL_WEIGHT_CALF_FOOD_KG']?>
                                            <?=$lang['COL_WEIGHT_DRY_FOOD_KG']?>
                                            <?=$lang['COL_OTHER_FOOD']?>
                                            <?=$lang['COL_PRICE_CALF_FOOD']?>
                                            <?=$lang['COL_PRICE_DRY_FOOD']?>
                                            <?=$lang['COL_PRICE_DAIRY_FOOD']?>
                                            <?=$lang['COL_PRICE_FEMALE_DAIRY_FOOD']?>
                                            <?=$lang['COL_WEIGHT_FOOD_KG']?>
										</tr>
									</thead>
									<tbody>
                                    <?echo $table ?>
...
// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $('#datatable_tabletools tbody td').editable('./update_food.php', {
        type      : 'textarea',
        name      : $(this).data('tdid'),
		fatherid  : 'indexid',
        "onblur"  : 'submit',

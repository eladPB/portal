...
$page_title = $lang['MARKETING_MEASUREMENT'];
...
$page_nav["data_entry"]["sub"]["marketing_measurement"]["active"] = true;
...
// Get table data
$table = $my_db->Get_Marketing_Measurement($farmid,$StartDate,$FinishDate);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
							...
							<div class="widget-body no-padding">
								...
								<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
											<?=$lang['COL_DATE']?>
											<?=$lang['COL_MARKETING_MONTHLY_DAYS']?>
											<?=$lang['COL_FOOD_MONTHLY_DAYS']?>
										</tr>
									</thead>
									<tbody>
                                    <?echo $table ?>
...
// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $('#datatable_tabletools tbody td').editable('./update_marketing_measurement.php', {
        type      : 'textarea',
        name      : $(this).data('tdid'),
		fatherid  : 'indexid',
        "onblur"  : 'submit',

...
$page_title = $lang['MILK_MEASUREMENT'];
...
$page_nav["data_entry"]["sub"]["milk_measurement"]["active"] = true;
...
// Get table data
$table = $my_db->Get_Milk_Measurement($farmid,$StartDate,$FinishDate);
?>
<!-- ==========================CONTENT STARTS HERE ========================== -->
<!-- MAIN PANEL -->
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false" >
						...
						<header>
							...
							<h2><?=$lang['MILK_MEASUREMENT_REPORT']?></h2>
							...
							<div class="widget-body no-padding">
								...
								<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
									<thead>
										<tr>
											<?=$lang['COL_DATE']?>
                                            <?=$lang['COL_COMPUTER_MORNING']?>
                                            <?=$lang['COL_MEASUREMENT_MORNING']?>
                                            <?=$lang['COL_MORNING_AMOUNT']?>
                                            <?=$lang['COL_COMPUTER_NOON']?>
                                            <?=$lang['COL_MEASUREMENT_NOON']?>
                                            <?=$lang['COL_NOON_AMOUNT']?>
                                            <?=$lang['COL_COMPUTER_EVENING']?>
                                            <?=$lang['COL_MEASUREMENT_EVENING']?>
                                            <?=$lang['COL_EVENING_AMOUNT']?>
                                            <?=$lang['COL_TOTAL_COMPUTER']?>
                                            <?=$lang['COL_MAMMALIAN_MILK']?>
                                            <?=$lang['COL_TANK_LITER']?>
                                            <?=$lang['COL_TANK_KG']?>
                                            <?=$lang['COL_DEVIATION']?>
										</tr>
...
// //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $('#datatable_tabletools tbody td').editable('./update_milk_measurement.php', {
        type      : 'textarea',
        name      : $(this).data('tdid'),
		fatherid  : 'indexid',
        "onblur"  : 'submit',
